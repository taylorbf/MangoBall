		...
		this.bounce = function(axis, hitblock) {
			if (hitblock.type!="water") {
				...
				switch (hitblock.type) {
					case "ice":
						this.deltax += (dream(10)-5)/2;
						break;
					case "jump":
						this.deltay -= 4;
						break;
					case "bridge":
						self.CurrentBlocks.splice(this.SelfIndex-1,1);
						break;
					case "water":
			...
			/*
									{ x: 300,  y: 150, width: 50, height: 5, type: "ice" },
									{ x: 200,  y: 200, width: 50, height: 5, type: "water" },
									{ x: 100,  y: 250, width: 50, height: 5, type: "jump" },
									{ x: 400,  y: 250, width: 50, height: 5, type: "bridge" }
			*/
