...
function mango(target, transmitCommand, uiIndex) {
	...
	*/
	...
	this.click = function(e) {
		if (self.moving) {
			self.midx = self.clickPos.x;
			self.midy = self.clickPos.y;
	...
	this.move = function(e) {
		if (self.moving) {
			self.midx2 = self.clickPos.x;
			self.midy2 = self.clickPos.y;
		}
	...
	this.release = function(e) {
		if (self.moving) {
			self.CurrentBalls[0].deltax = (self.midx - self.midx2)/slingAffect;
			self.CurrentBalls[0].deltay = (self.midy - self.midy2)/slingAffect;
		}
		if (self.slinging) {
			self.startShot();
		}
