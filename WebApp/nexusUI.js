...
$(document).ready(function() {
	...
	if (nx.is_touch_device) {
		document.getElementById("mango1").addEventListener("touchmove", nx.blockMove, true);
		document.getElementById("mango1").addEventListener("touchstart", nx.blockMove, true);
	}
